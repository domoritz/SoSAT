...
class GeneticAlgorithm(algo.Algorithm):
    ...
    # If the dtandard derivative goes below this value,
    ...
    def adapat_mutation_rate_if_needed(self, iteration):
    ...
    def run(self):
        ...
        for iteration in xrange(self.MAX_ITERATIONS):
            ...
            if not iteration % self.ADAPT_EVERY:
                self.adapat_mutation_rate_if_needed(iteration)
